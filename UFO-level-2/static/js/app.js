...
function ufoSightingFilter() {
    ...
    var inputValue = d3.select("#sub-category").property("value");
    var inputData = data.filter(d => (d.datetime===inputValue || d.city===inputValue || d.state===inputValue || d.country===inputValue || d.shape===inputValue));
    inputData.forEach(d => {
